export const CSSPROPERTYTAB = {
  "& .MuiTab-root": {
    color: "darkgray !important", // Inactive tab "color"
  },
  "& .Mui-selected": {
    color: "white !important",
    // textColor: "white", // Active tab color
  },
  "& .MuiTabs-indicator": {
    backgroundColor: "white !important", // Indicator line color
  },
};
...
export const DELETEBUTTON =
  "rounded-xl bg-red-600 text-white my-1 p-1 hover:bg-red-300 hover:text-black";
...
export const ADDBUTTON =
  "rounded-xl bg-green-600 text-white font-bold h-12 my-5 me-5 ms-2 w-32 hover:cursor-pointer";
...
export const VALIDATIONRULE = "text-red-400 font-semibold drop-shadow-md text-xs";

export const VALIDATIONWARNING = "text-orange-500 font-bold drop-shadow-md";
